...
extension UIView
{
    func fs_contentHuggingPriority(priority: UILayoutPriority,
    ...
    func fs_contentCompressionResistancePriority(priority: UILayoutPriority,
                                                 layoutConstraintAxis: UILayoutConstraintAxis) -> Self
    {
    ...
    func fs_translatesAutoresizingMaskIntoConstraints(isActive: Bool) -> Self
    {
        self.translatesAutoresizingMaskIntoConstraints = isActive
        return self
    }
    
    func fs_centerXAnchor(equalTo: NSLayoutXAxisAnchor,
                          constant: CGFloat = 0,
    ...
    func fs_centerYAnchor(equalTo: NSLayoutYAxisAnchor,
                          constant: CGFloat = 0,
                          isActive: Bool = true) -> Self
    {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func fs_leftAnchor(equalTo: NSLayoutXAxisAnchor,
                       constant: CGFloat = 0,
                       isActive: Bool = true) -> Self
    {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func fs_rightAnchor(equalTo: NSLayoutXAxisAnchor,
                        constant: CGFloat = 0,
                        isActive: Bool = true) -> Self
    {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func fs_topAnchor(equalTo: NSLayoutYAxisAnchor,
                      constant: CGFloat = 0,
                      isActive: Bool = true) -> Self
    {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func fs_bottomAnchor(equalTo: NSLayoutYAxisAnchor,
                         constant: CGFloat = 0,
                         isActive: Bool = true) -> Self
    {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func fs_widthAnchor(equalTo: NSLayoutDimension,
                        constant: CGFloat = 0,
    ...
    func fs_widthAnchor(equalToConstant: CGFloat,
                        identifier: String? = nil,
                        isActive: Bool = true) -> Self
    {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func fs_heightAnchor(equalTo: NSLayoutDimension,
                         constant: CGFloat = 0,
                         multiplier: CGFloat = 1.0,
                         identifier: String? = nil,
                         constraint: AutoreleasingUnsafeMutablePointer<NSLayoutConstraint?>,
    ...
    func fs_heightAnchor(equalToConstant: CGFloat,
                         identifier: String? = nil,
                         isActive: Bool = true) -> Self
    {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func fs_heightAnchor(greaterThanOrEqualToConstant: CGFloat,
                         priority: UILayoutPriority,
                         isActive: Bool = true) -> Self
    {
        translatesAutoresizingMaskIntoConstraints = false
